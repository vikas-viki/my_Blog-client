...
const Commentform =  ({ articleName, setArticleInfo }) => {
    ...
    const addComment = async () => {
        const result = await fetch(`http://localhost:8000/api/articles/${articleName.name}/add-comments`, {
            method: "post",
    ...
    return (
        <form className="shadow rounded px-8 pt-6 pb-8 mb-4"  onSubmit={(e) =>{ addComment(); e.preventDefault()}} >
